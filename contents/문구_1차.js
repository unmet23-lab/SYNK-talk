...
const 목록 = [
  ...
  },
  {
    ...
    source_ko: '6자 이상',
    draft_mn: null,
    context: '비밀번호 칸 오른쪽에 작게 붙는 도움말(12px). 라벨과 같은 줄을 나눠 쓰므로 **매우 짧아야** 한다.',
    max_len: 12,
    source_file: 'src/인증화면.js',
  },
  {
