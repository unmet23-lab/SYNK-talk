...
export default function 말하기화면({
  ...
  return (
    <ScrollView style={s.wrap} contentContainerStyle={s.inner} keyboardShouldPersistTaps="handled">
      ...
      {과제 && 과제.출처 === '고정' && (
        <View>
          {!과제.첫만남 && <Text style={s.메모}>오늘은 연습 문장으로 말해요 — {과제.사유}</Text>}
