 ...
 *
 * ■ 🔑 사과 전략 3장 (발주 G1 §4-4의 선택 의미 · 문구는 현재 학생 화면)
...
/**
 * 사과 전략 3장 — 발주 G1 §4-4의 선택 의미를 쉬운 말로 표시한다. 보기와 차원은 **한 객체**다
...
export const 사과전략 = Object.freeze({
  차원: 차원들.사과전략,
  보기들: Object.freeze([
    Object.freeze({ option_id: 'g1-사과-솔직', label: '무슨 일이 있었는지 설명해요' }),
    Object.freeze({ option_id: 'g1-사과-간결', label: '짧게 사과하고 부탁해요' }),
    Object.freeze({ option_id: 'g1-사과-대안', label: '제가 할 수 있는 일을 말씀드려요' }),
  ]),
});
