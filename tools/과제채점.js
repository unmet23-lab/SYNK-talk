...
const 축이름 = ['①연결성', '②답변가능', '③수준적합', '④신선함', '⑤재미', '⑥정확성', '⑦배우는 이유', '⑧상태활용'];   // ⑦ = 카드의 「이 학생이 한국어를 배우는 이유」와 같은 낱말(유호 08-25 「직관적으로」)
...
function 재료() {
  ...
  const 몸 = {
    ...
    통과선표기: Object.fromEntries(평가.축키들.map((k) => [k, 평가.통과선표기(k)])), 구간축: 평가.구간축,
    앵커: 평가.앵커, 상태들, 행들,
  };
