...
// 게임 로그(G1 큐)도 귀속이다 — 남기면 다음 학생의 게임 화면이 앞 학생의 「이미 보냈다」를 읽고,
// 밀린 재전송이 앞 학생의 메일을 다음 학생 토큰으로 올린다(제출 로그와 같은 사고 · 소급 0).
const 지워야할것 = ['로그쓰기', '교정로그쓰기', '게임로그쓰기', '세션지우기'];
